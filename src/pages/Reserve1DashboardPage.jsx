...
export function Reserve1DashboardPage() {
  const buttonsData = [{}];
  ...
  return (
    <div className="flex bg-[#E9EFEC] h-[100vh]">
      ...
      <div className="flex flex-col w-screen mr-2 ml-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-5 p-6 flex-1 overflow-y-auto"></div>
      </div>
    </div>
  );
}
